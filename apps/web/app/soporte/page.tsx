...
const sections = [
  {
    ...
    body: "Still aparece gracias a una automatización personal de la app Atajos: «Cuando se abra [app] → Pausar [app]». Revisa que exista para cada app elegida y que tenga desactivado «Preguntar antes de ejecutar». La app que abriste se ve un instante antes de que llegue Still; así ordena iOS las automatizaciones.",
  },
  {
