...
const REASONS = [
  {
    ...
    icon: (
      <svg {...ICON_PROPS}>
        ...
        <path pathLength={1} d="M8 10V7a4 4 0 0 1 7.5-2" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg {...ICON_PROPS}>
        <circle pathLength={1} cx="12" cy="13" r="8" />
        <path pathLength={1} d="M12 9v4l2.5 2.5" />
        <path pathLength={1} d="M9 2h6" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg {...ICON_PROPS}>
        <path pathLength={1} d="M4 6h16" />
        <path pathLength={1} d="M4 12h10" />
        <path pathLength={1} d="M4 18h13" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg {...ICON_PROPS}>
        <rect pathLength={1} height="20" rx="3" width="12" x="6" y="2" />
        <path pathLength={1} d="M11 18h2" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg {...ICON_PROPS}>
        <path pathLength={1} d="M20 12v9H4v-9" />
        <path pathLength={1} d="M2 7h20v5H2z" />
        <path pathLength={1} d="M12 21V7" />
        <path pathLength={1} d="M12 7C10 3 7 3 7 5s5 2 5 2 5 0 5-2-3-2-5 2" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg {...ICON_PROPS}>
        <circle pathLength={1} cx="12" cy="8" r="4" />
        <path pathLength={1} d="M4 21c1.5-4 4.5-6 8-6s6.5 2 8 6" />
      </svg>
    ),
  },
];
    ...
    <section aria-labelledby="why-still-title" className={styles.section}>
      <div className={`shell ${styles.inner}`}>
        <div className={styles.heading}>
          ...
          <h2 className="section-title" data-reveal="mask" id="why-still-title">
