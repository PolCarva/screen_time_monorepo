...
type DevOverridable = Pick<RemoteConfig, "iosRestrictionEnabled">;
 ...
 * exercise on a simulator or a development device. This switch turns it on
 * for a development build only. It changes nothing on the server, so unlock
