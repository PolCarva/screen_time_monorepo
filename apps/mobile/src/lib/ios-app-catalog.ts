...
export const IOS_APP_CATALOG: readonly CatalogApp[] = [
  ...
  { id: "signal", name: "Signal", aliases: [], scheme: "sgnl" },
  { id: "duolingo", name: "Duolingo", aliases: [], scheme: "duolingo" },
  { id: "soundcloud", name: "SoundCloud", aliases: [], scheme: "soundcloud" },
  { id: "shazam", name: "Shazam", aliases: [], scheme: "shazam" },
