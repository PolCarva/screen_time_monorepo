...
RCT_EXTERN_METHOD(syncWallet:(nonnull NSNumber *)rewarded emergency:(nonnull NSNumber *)emergency resetAt:(NSString *)resetAt resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
