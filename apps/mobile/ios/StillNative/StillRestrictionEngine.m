...
RCT_EXTERN_METHOD(finishShortcutSetupTest:(NSString *)contextId resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
...
RCT_EXTERN_METHOD(syncWallet:(nonnull NSNumber *)rewarded resetAt:(NSString *)resetAt estimatedMinutesPerAvoidedOpen:(nonnull NSNumber *)estimatedMinutesPerAvoidedOpen unlockDurationSeconds:(nonnull NSNumber *)unlockDurationSeconds restrictionsEnabled:(nonnull NSNumber *)restrictionsEnabled resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
RCT_EXTERN_METHOD(getAccessWindows:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
